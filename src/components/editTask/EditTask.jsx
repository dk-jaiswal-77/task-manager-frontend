...
export default function EditTask(){
    ...
    const taskId = JSON.parse(localStorage.getItem("taskToBeEdited_taskId"));
    ...
    // ----------------------------------------------------------------------------->
    const [subtasks, setSubtasks] = useState([...taskToBeEdited.subtasks]);
    ...
    return (
        <div className="right_container">
            ...
            <div className="right_cont">
                <button className="createBtn" onClick={updateTaskInDB}>Update Task</button>
            </div>
